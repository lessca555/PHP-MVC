        ...
        <div class="col-lg-6">
            ...
            <ul class="list-group">
                <?php foreach( $data['mhs'] as $mhs ) : ?>
                    ...
                    <?= $mhs['nama']; ?>
                    <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Anda yakin ingin menghapus?')">hapus</a>
        ...
        <div class="modal-body">
            ...
            <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary ubahData">Tambah Data</button>
                </div>
            </form>
        </div>
